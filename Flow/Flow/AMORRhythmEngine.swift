...
enum AMORRhythmEngine {
    ...
    private static func miniScore(sessions: [DailySession], practices: [PracticeStreak]) -> Int {
    ...
    private static func detectTimeEnergyCorrelation(sessions: [DailySession]) -> [RhythmCorrelation] {
        let highEnergyMoods: Set<String> = ["focused", "energized", "flow", "excited", "productive", "inspired"]
        let calendar = Calendar.current
    ...
    private static func detectDayVolumeCorrelation(sessions: [DailySession]) -> [RhythmCorrelation] {
        let calendar = Calendar.current
    ...
    private static func detectToolAffinityCorrelation(sessions: [DailySession]) -> [RhythmCorrelation] {
        let highEnergyMoods: Set<String> = ["focused", "energized", "flow", "excited", "productive", "inspired"]
    ...
    private static func countActiveDays(sessions: [DailySession]) -> Int {
        let calendar = Calendar.current
    ...
    private static func mostCommonMood(sessions: [DailySession]) -> String? {
    ...
    private static func mostCommonTool(sessions: [DailySession]) -> String? {
        guard !sessions.isEmpty else { return nil }
        var counts: [String: Int] = [:]
        for s in sessions {
